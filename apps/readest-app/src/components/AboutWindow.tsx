        ...
        <div className='about-content flex flex-col items-center justify-center gap-4 pb-10 sm:pb-0'>
          <div className='flex flex-1 flex-col items-center justify-end gap-2 px-8 py-2'>
            ...
            <div className='flex select-text flex-col items-center'>
              <h2 className='mb-2 text-2xl font-bold'>Bookarc</h2>
          ...
          >
            <p className='text-neutral-content text-sm'>
              © {new Date().getFullYear()} Orpheus Technology Ltd. All rights reserved.
            </p>
            ...
            <p className='text-neutral-content text-xs'>
              ...
              <Link
                href='https://github.com/prowriting/readest'
                className='text-blue-500 underline'
              >
                GitHub
              </Link>
